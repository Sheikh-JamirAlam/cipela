...
export default function FeaturedBackground() {
  ...
  return (
    <div ref={container} className="w-full absolute">
      ...
      <motion.img style={{ y: yMercurialAnimate, rotate: rotateMercurialAnimate }} className="w-[25rem] ml-auto mr-20 mt-[20%]" src="/images/mercurial-small.png" alt="Mercurial Image" />
      <motion.img style={{ y: yViniAnimate, rotate: rotateViniAnimate }} className="w-[25rem] mr-auto ml-40" src="/images/r9-small.png" alt="Vini Image" />
